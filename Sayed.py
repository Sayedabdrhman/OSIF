...
print "Hello, Aravind!"## Sayed.py - Sayed sec v1.0
# -*- coding: utf-8 -*-
##
import os
import sys
from time import sleep as timeout
from core.Sayed import *
